...
class ToolChainExplorerWeightedSelectSet(ToolChainExplorer):
    """
    Stochastic Search.
    ...
    def __init__(
        ...
        """
        super(ToolChainExplorerWeightedSelectSet, self).__init__(
            simgr,
            max_length,
            exp_dir,
            nameFileShort,
        ...
        self.log = logging.getLogger("ToolChainExplorerWeightedSelectSet")
