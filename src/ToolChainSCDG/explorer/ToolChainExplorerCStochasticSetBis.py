...
class ToolChainExplorerCStochasticSetBis(ToolChainExplorer):
    """
    Stochastic Search.
    ...
    def __init__(
        ...
        """
        super(ToolChainExplorerCStochasticSetBis, self).__init__(
            simgr,
            max_length,
            exp_dir,
            nameFileShort,
        ...
        self.log = logging.getLogger("ToolChainExplorerCStochasticSetBis")
