...
class ToolChainExplorerCStochasticBis(ToolChainExplorer):
    """
    Stochastic Search.
    ...
    def __init__(
        ...
        """
        super(ToolChainExplorerCStochasticBis, self).__init__(
            simgr,
            max_length,
            exp_dir,
            nameFileShort,
        ...
        self.log = logging.getLogger("ToolChainExplorerCStochasticBis")
