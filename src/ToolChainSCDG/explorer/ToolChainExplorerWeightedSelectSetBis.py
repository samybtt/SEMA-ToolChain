...
class ToolChainExplorerWeightedSelectSetBis(ToolChainExplorer):
    """
    Stochastic Search.
    ...
    def __init__(
        ...
        """
        super(ToolChainExplorerWeightedSelectSetBis, self).__init__(
            simgr,
            max_length,
            exp_dir,
            nameFileShort,
        ...
        self.log = logging.getLogger("ToolChainExplorerWeightedSelectSetBis")
