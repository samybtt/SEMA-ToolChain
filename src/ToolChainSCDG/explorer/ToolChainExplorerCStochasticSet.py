...
class ToolChainExplorerCStochasticSet(ToolChainExplorer):
    """
    Stochastic Search.
    ...
    def __init__(
        ...
        """
        super(ToolChainExplorerCStochasticSet, self).__init__(
            simgr,
            max_length,
            exp_dir,
            nameFileShort,
        ...
        self.log = logging.getLogger("ToolChainExplorerCStochasticSet")
