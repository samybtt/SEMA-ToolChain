...
class ToolChainExplorerDPP(ToolChainExplorer):
    def __init__(
        self,
        simgr,
        max_length,
        ...
        super(ToolChainExplorerDPP, self).__init__(
            simgr,
            max_length,
            exp_dir,
            nameFileShort,
        ...
        self.log = logging.getLogger("ToolChainExplorerDPP")
    ...
    def step(self, simgr, stash="active", **kwargs):
        ...
        # def dynamic_path_pruning(state):
        #     upr = estimate_unsat_path_rate(total_results)
        #     checking_rate = generate_new_checking_rate(upr)
        #     total_results = []

        #     if should_check(checking_rate):
        #         result = state.solve()
